...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.getFirstName = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var name = value.data.firstName;
        return name;
    };
    ProfileComponent.prototype.getLastName = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var name = value.data.lastName;
        return name;
    };
    ProfileComponent.prototype.getEmail = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var name = value.data.email;
        return name;
    };
    ProfileComponent.prototype.getVerified = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var name = value.data.verified;
        return name;
    };
    ProfileComponent.prototype.getverificationToken = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var EthAddress = value.data.verificationToken;
        return EthAddress;
    };
    ...
    ProfileComponent.prototype.getgeneratedInvestorCode = function () {
        var value = JSON.parse(localStorage.getItem('user'));
        var EthAddress = value.data.generatedInvestorCode;
        return EthAddress;
    };
